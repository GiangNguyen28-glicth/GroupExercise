...
<div class="container" style="padding-top: 95px;" id="exercise">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="product-item">
                <a class="imagehover" href="#"><img src="<c:url value='template/images/product_02.jpg'/>" alt=""></a>
                <div class="down-content">
                    <a href="#">
        ...
        <div class="col-md-4">
            <div class="product-item">
                <a href="#"><img class="imagehover" src="<c:url value='template/images/product_03.jpg'/>" alt=""></a>
                <div class="down-content">
                    <a href="#">
                        <h4>Tittle goes here</h4>
                    </a>
        ...
        <div class="col-md-4">
            <div class="product-item">
                <a href="#"><img class="imagehover" src="<c:url value='template/images/product_05.jpg'/>" alt=""></a>
                <div class="down-content">
                    <a href="#">
                        <h4>Tittle goes here</h4>
                    </a>
        ...
        <div class="col-md-4">
            <div class="product-item">
                <a href="#"><img class="imagehover" src="<c:url value='template/images/product_06.jpg'/>" alt=""></a>
                <div class="down-content">
                    <a href="#">
                        <h4>Tittle goes here</h4>
                    </a>
